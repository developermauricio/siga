...
function dokan_progressbar_translated_string( $string = '', $value = 15, $progress = 0 ) {
    ...
    switch ( $string ) {
        ...
        case 'banner_val':
            // TODO: cambios return sprintf( __( 'Add Banner to gain %s%% progress', 'dokan' ), number_format_i18n( $value ) );
            return sprintf( __( 'Agregar Banner para obtener un %s%% de progreso', 'dokan' ), number_format_i18n( $value ) );
            break;
